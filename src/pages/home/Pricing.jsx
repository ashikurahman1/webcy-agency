    ...
    <div className="section-container">
      ...
      <div className="text-center mb-10">
        <label className="inline-flex items-center cursor-pointer">
          ...
          <div className="relative">
            ...
            <div
              className={`toggle-circle absolute top-1 left-1 w-6 h-6 bg-sky-700 rounded-full transition-transform duration-300 ${
                isYearly ? 'transform translate-x-6' : 'Monthly Pricing'
              }`}
            ></div>
          </div>
        </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {pricingPlans.map(plan => (
          <div
            key={plan.name}
            className="bg-white border border-stone-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl"
          >
            {/* Top */}
            ...
            <div className="p-5 text-center">
              <button className="bg-sky-700 text-white px-6 py-2 rounded-full hover:bg-sky-900 transition duration-300">
                Choose {plan.name}
              </button>
            </div>
            {/* Features */}
